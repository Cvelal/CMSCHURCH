                            ...
                            <form method="POST" action="{{ route('password.request') }}"
                                ...
                                <div class="modal-body mx-3">
                                    <div class="md-form mb-5">
                                        <label data-error="wrong" data-success="right"
                                            for="defaultForm-email">{{ __('Correo') }}</label>
                                ...
                                <div class="modal-body mx-3">
                                    <div class="md-form mb-5">
                                        ...
                                        <input id="password defaultForm-pass" type="password"
                                ...
                                <div class="modal-body mx-3">
                                    <div class="md-form mb-5">
                                        <label data-error="wrong" data-success="right" for="defaultForm-pass">Confirme la contraseña nueva</label>
                                        <i class="fa fa-lock prefix grey-text"></i>
                                        <input id="password-confirm defaultForm-pass" type="password"
                                            class=" validate form-control{{ $errors->has('password') ? ' is-invalid' : '' }}"
