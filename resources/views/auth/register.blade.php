    ...
    <div id="container" class="cls-container">
        ...
        <div class="cls-content">
            <div class="title m-b-md">
                <h1 class=" text-light">Registro de la Iglesia</h1>
            </div>
            ...
            <div class="cls-content-lg panel">
                <div class="panel-body">
                    <div class="mar-ver pad-btm text-light">
                        <h1 class="h3 text-light">Crea una nueva cuenta principal</h1>
                        <p>Configura tu cuenta.</p>
                    </div>
                    @if (isset($_GET['s']))
                        <div class="alert alert-success" role="alert">
                            <span class="text-danger">
                                <strong>Nueva cuenta añadida satisfactoriamente</strong>
                            </span>
                        </div>
                    @endif
                    <form id="branch-form" action="{{ route('visitor.register') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input id="branchname" placeholder="Nombre de la Iglesia" type="text"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input id="branchcode" placeholder="ID de la Iglesia" type="text"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input id="password-confirm" type="password" placeholder="Confirmación de contraseña"
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <textarea type="text" class="form-control" placeholder="Dirección de la iglesia" name="address"></textarea>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control {{ $errors->has('currency') ? ' is-invalid' : '' }}"
                                        name="currency" required placeholder="Ingrese el tipo de cambio">
                                        <option value="" selected disabled>Cambio</option>
                                        @foreach ($currencies as $currency)
                                            @if ($currency->currency_symbol)
