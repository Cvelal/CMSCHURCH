...
@section('content')
    ...
    <div id="content-container">
        <div id="page-head">
            ...
            <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
            <div id="page-title">
                <h1 class="page-header text-overflow">Afiliación</h1>
            </div>
            <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
            <!--End page title-->
        ...
        <div id="page-content">
            ...
            <div class="panel" style="background-color: #e8ddd3;">
                <div class="panel-heading">
                    <h3 class="panel-title">Listado de miembros en {{ \Auth::user()->branchname }}</h3>
                </div>
                @if (session('status'))
                    ...
                    <div class="col-md-6">
                        <ul class="list-group">
                            ...
                            @foreach ($reports as $report)
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    Número total de Personas solteras
                                    <span class="badge badge-primary badge-pill">{{ $report->single }}</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    Número total de Personas Casadas
        ...
        <div class="col-md-12 col-md-offset-0" style="margin-bottom:20px">
            <div class="panel" style="background-color: #e8ddd3; overflow:scroll">
                <div class="panel-heading">
                    <h3 class="panel-title"><strong>Reporte <i>de los Últimos</i> 4 años </strong> de Registro de miembros</h3>
                </div>
                <div class="panel-body">
