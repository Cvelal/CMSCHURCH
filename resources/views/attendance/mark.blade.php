...
@section('content')
    ...
    <div id="content-container">
        <div id="page-head">
            ...
            <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
            <div id="page-title">
                <h1 class="page-header text-overflow">Marcar Asistencia</h1>
            </div>
            <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
            <!--End page title-->
            ...
            <div class="col-md-12 col-md-offset-0 col-lg-8 col-lg-offset-1" style="margin-bottom:20px">
                <div class="panel rounded-top" style="background-color: #e8ddd3;">
                    <div class="panel-heading">
                        <h3 class="panel-title text-center">Marcar asistencia para <strong>{{ \Auth::user()->branchname }}
                    ...
                    @if (!count($services) > 0)
                        <div class="col-12 well text-center bg-danger">
                            <div class="text-lg">
                                <div class="col-8">
                                    Oooops! Para marcar la asistencia debe crear un tipo de servicio aquí.
                                </div>
                                <div class="col-4">
                                    <a class="btn btn-info" href="{{ route('branch.tools') }}">Agregar tipo de servicio</a>
                                </div>
                            </div>
                        </div>
                    @else
                        ...
                        <form id="b-attendance-form" method="POST" action="{{ route('attendance.submit') }}">
                            ...
                            <div class="panel-footer text-right bg-dark">
                                <button id="btn-mark" class="btn btn-success" type="submit">Cargar</button>
                            </div>
                        </form>
                    @endif
                </div>
                            ...
                            <form id="m-attendance" action="{{ route('attendance.mark') }}" method="post">
                                ...
                                <table id="mTable" class="table table-striped table-bordered datatable text-dark"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Nombres</th>
                                            <th>Apellidos</th>
                                            <th><input id="select-all" type="checkbox" />Marcar todo</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php $count = 1; ?>
                                            ...
                                            <tr class="<?php echo $class[$num]; ?>" id="row,{{ $count }}">
                                                ...
                                                <td>
                                                    <div id="" class="input-group">
                                                        <div class="checkbox">
                                                            <label><input name="atte" type="checkbox">Presente<input
                                ...
                                <div class="row">
                                    <div class="col-md-3" style="width:30%;">
                                        <h3><label for="date">Elegir fecha</label></h3>
                                        <input
                                            ...
                                            type="text" placeholder="Elegir fecha" name="date"
                                            class="datepicker form-control" required />
                                    </div>

                                    <div class="form-group col-md-3">
                                        <h3><label for="date">Elegir tipo de servicio</label></h3>
                                    ...
                                    <div class="col-md-3 form-group pull-right" style="">
                                        <h3><label for="date">Cargar Asistencia</label></h3>
                                        <div class="input-group" style="width:100%">
                                            <input id="m-submit-btn" type="submit" name="save" value="Cargar"
