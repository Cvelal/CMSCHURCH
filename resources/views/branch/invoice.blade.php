...
@section('content')
    ...
    <div id="content-container">
        <div id="page-head">
            ...
            <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
            <div id="page-title">
                <h1 class="page-header text-overflow">Factura</h1>
            </div>
            <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
            <!--End page title-->
            <!--Breadcrumb-->
        ...
        <div id="page-content">
          ...
          <td class="total-value balance"><div class="due">$875.00</div></td>
                        ...
                        <div id="terms">
                            <h5>Terms</h5>
                            <div>Comision de {{ $percentage }}% será cargado en cada donativo</div>
                        </div>
                        <!-- </div> -->
                        <div class="pull-left">
                        ...
                        <div class="pull-right">
                            <form class="" action="{{ route('pay') }}" method="post">
                                ...
                                <button type="submit" name="button" class="btn btn-success"><i
                                        class="fa fa-money"></i> Continue a pagar</button>
                            </form>
                        </div>
                    </div>
                </div>
