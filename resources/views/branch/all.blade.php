...
@section('content')
    ...
    <div id="content-container">
        <div id="page-head">
            <!--Page Title-->
            <div id="page-title">
                <h1 class="page-header text-overflow">Ministerio</h1>
            </div>
            <!--End page title-->
            <!--Breadcrumb-->
            <ol class="breadcrumb">
        ...
        <div id="page-content">
            ...
            <div class="panel" style="overflow:scroll; background-color: #e8ddd3;">
                <div class="panel-heading">
                    <h3 class="panel-title">Listado de todos los Ministerios</h3>
                </div>
...
@section('js')
    ...
    <script>
        ...
        function del(d) {
            var confirmed = confirm('Confirma para eliminar');
