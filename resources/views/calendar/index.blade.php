                        ...
                        <div class="fixed-sm-200 pull-sm-left fixed-right-border">
                            <form method="POST" action="{{ route('calendar.update') }}">
                                ...
                                <div class="form-group">
                                    <input type="text" id="event_title" placeholder="Titulo del Evento" name="title"
                                    ...
                                    <br />
                                    <input type="text" id="event_title" placeholder="Localización" name="location"
                                        class="form-control" value="" required>
                                    <input type="text" id="event_title" placeholder="Detalles" name="details"
                                        class="form-control" value="" required>
                                  ...
                                  background-color: #fff;outline:none; margin-top:15px;padding:2px 10px"
                                        type="text" placeholder="Fecha del Evento" name="date" class="datepicker"
                                        required />
                                </div>

                                <button class="btn btn-block btn-purple btn-lg">Agregar nuevo Evento</button>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button id="id" type="button" class="btn btn-danger" value=""
                                data-dismiss="modal" onclick="dele(this.value);">Borrar</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Encabezado de MOdelo</h4>
                </div>
