    ...
    <div id="content-container">
        <div id="page-head">
            ...
            <div class="text-center">
                <h3>Bienvenida <strong>{{ strtoupper($user->branchname) }}</strong></h3>
            </div>
        ...
        <div id="page-content">
                ...
                <div class="panel-body">
                    <div class="row mar-top">
                        <div class="col-md-4 text-center">
                            <h3 class="text-main text-normal text-2x mar-no">Estadisticas "Miembros"</h3>
                            <!-- <h5 class="text-uppercase text-muted text-normal">Reporte de los ultimos 12 meses</h5> -->
                            <div class="row mar-top">
                                <div class="col">
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="row mar-top">
                        <div class="col-md-4">
                            <h3 class="text-main text-normal text-2x mar-no">Estadísticas de recolecciones</h3>
                            <!-- <h5 class="text-uppercase text-muted text-normal">Reporte de los ultimos 12 meses</h5> -->
                            <div class="row mar-top">
                                <div class="col">
                                    <table class="table table-condensed table-trans">
                            ...
                            <div class="row">
                                @if ($isAdmin)
                                    <div class="col-xs-{{ $isAdmin ? '4' : '6' }}">
                                        <label for="show" class="">Ver</label>
                                        <select id="show" required style="outline:none;" name="sort"
                                            class="selectpicker col-md-12" data-style="btn-primary">
                                            <option selected value="false">Esta Iglesia</option>
                                            <option value="true">Todas las iglesias</option>
                                        </select>
                                    </div>
                                @endif
                                <div class="col-xs-{{ $isAdmin ? '4' : '6' }}">
                                ...
                                <div class="col-xs-{{ $isAdmin ? '4' : '6' }}">
                                    <label for="range" class="">Rango</label>
                                    <select id="m-i" required style="outline:none;" name="range"
                                        ...
                                        <option selected disabled value="">Seleccione el número de meses</option>
                                        @for ($i = 1; $i < 13; $i++)
                                            <option value="{{ $i }}">Últimos{{ $i }} Meses</option>
                                        @endfor
                                    </select>
                                </div>
                            </div>
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="row mar-top">
                        <div class="col-md-4">
                            <h3 class="text-main text-normal text-2x mar-no">Estadisticas de Asistencia</h3>
                            <!-- <h5 class="text-uppercase text-muted text-normal">Reporte de los ultimos 12 meses</h5> -->
                            <div class="row mar-top">
                                <div class="col">
                                    <table class="table table-condensed table-trans">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="panel">
                        <div class="panel-heading">
                            <!--body text-center"-->
                            <h3 class="panel-title"><strong>Aniversarios de boda <?php 
                            $i = 1; ?></strong> </h3>
                        ...
                        <div class="panel-body text-center clearfix">
                            ...
                            @else
                                <p class="text-danger"> No hay Aniversarios </p>
                            @endif
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="panel">
                        <div class="panel-heading">
                            <!--body text-center"-->
                            <h3 class="panel-title"><strong>Cumpleaños <?php ?></strong> </h3>
                            <!--i class="demo-pli-coin icon-4x"></i-->
                        </div>
                        <div class="panel-body text-center clearfix">
                            @if (count($celebs) > 0)
                            ...
                            @else
                                <p class="text-danger"> No hay cumpleaños </p>
                            @endif
                        </div>
                    </div>
                </div>
                ...
                <div class="panel-body">
                    <div class="row mar-top">
                        ...
                        <div class="col-md-{{ $user->isAdmin() ? 5 : 9 }}">
                            <h3 class="text-center">Ofrendas</h3>
                            <div class="table-responsive">
                        ...
                        @if ($user->isAdmin())
                            <div class="col-md-4">
                                <h3 class="text-center">Iglesia propia</h3>
                                <div class="table-responsive">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="panel">
                        <div class="panel-heading">
                            <h1 class="text-bold text-center ji">Proximos Eventos para {{ strtoupper($user->branchname) }}
                            </h1>
                        </div>
                        ...
                        <div class="panel-footer text-center">
                            ...
                            @if (count($eventss) < 1)
                                <p class="text-danger"> No hay evento </p>
                            @endif
                ...
                <div class="col-md-6">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h1 class="text-bold text-center ji">Anuncios</h1>
                        </div>
                        ...
                        <div class="panel-footer text-center">
                            @if (count($eventsall) < 1)
                                <p class="text-danger"> No hay nuevos anuncios</p>
                            @endif
...
@section('js')
    ...
    <script>
        ...
        var monthName = ["Ene", "Feb", "Mar", "Abr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dic"]
